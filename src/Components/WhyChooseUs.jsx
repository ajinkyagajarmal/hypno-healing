// // src/Components/WhyChooseUs.jsx (New, Simple, and Error-Free)
...
// // This is now a "dumb" component. It has no state and no effects.
// const WhyChooseUs = () => {
//   return (
...
//           <h2 className={styles.title}>A Path to Inner Peace! 💫 </h2>
//           <p className={styles.subtitle}>
//             We believe in a healing process built on trust, expertise, and genuine care. Here’s why clients choose Hypnohealing for their transformative journey.
//           </p>
//         </div>

//         {/* The timeline and feature list are now purely visual */ }
